...
class Food_Truck_Lite_Icon_Selector extends WP_Customize_Control{
      public $type = 'icon';
            ...
            <label>
                  ...
                  <ul class="icon-list">
                      <div class="social-icon-search">
                          <input class="socialInput" type="text" placeholder="<?php echo esc_attr('Search Icon', 'food-truck-lite'); ?>">
                      </div>
                    <?php
                    $food_truck_lite_font_awesome_icon_array = food_truck_lite_font_awesome_icon_array();
                    foreach ($food_truck_lite_font_awesome_icon_array as $food_truck_lite_font_awesome_icon) {
                            $icon_class = $this->value() == $food_truck_lite_font_awesome_icon ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($food_truck_lite_font_awesome_icon).'"></i>
                            <span class="food-truck-lite-social-class">'.esc_attr($food_truck_lite_font_awesome_icon).'</span>
                            </li>';
                        }
                    ?>
                  </ul>
...
function food_truck_lite_customizer_script() {
     
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/css/fontawesome-all.css');
}
add_action( 'customize_controls_enqueue_scripts', 'food_truck_lite_customizer_script' );

if(!function_exists('food_truck_lite_font_awesome_icon_array')){
    function food_truck_lite_font_awesome_icon_array(){
