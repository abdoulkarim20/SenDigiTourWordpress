...
?>
 <!-- Start CTA Section -->
	  <section class="cta-7 bg-img" style="background-image: url(<?php if($techup_co2_image) { echo esc_url($techup_co2_image); } else { echo esc_url(get_header_image()); } ?>);">
        <div class="container">
            <div class="row">
              <div class="col-md-8 fadeInLeft" data-wow-delay="300ms" data-wow-duration="3000ms">
                <h2 class="c-white"><?php echo esc_html($techup_callout_title); ?></h2>
                <p class="c-white mb-0"><?php echo esc_html($techup_callout_content); ?></p>
              </div>
              <div class="col-md-4 fadeInRight" data-wow-delay="400ms" data-wow-duration="3000ms">
