...
{
	$techup_blog_title 	= get_theme_mod( 'techup_blog_title', esc_html__( 'Our News & Blogs','software-techup'));
	$techup_blog_subtitle 	= get_theme_mod( 'techup_blog_subtitle', esc_html__( 'Latest News','software-techup') );
	$techup_rm_button_label 	= get_theme_mod( 'techup_rm_button_label', esc_html__( 'Read More','software-techup'));
	...
	<!-- blog start-->
        ...
        <div  class="container">
          <div class="section-title">
            ...
            <h2 class="blog-title"><?php echo esc_html($techup_blog_title); ?></h2>
            <?php endif; ?>
            ...
            <div class="row">
				...
				?>
                  <div class="col-lg-4 col-md-6 col-sm-12">
                    <article class="blog-item blog-1 fadeInLeft" data-wow-delay="300ms" data-wow-duration="3000ms">
                        <div class="post-img">
